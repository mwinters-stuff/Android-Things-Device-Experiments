...
extern "C"
jbyteArray
Java_com_example_androidthings_pca6895servotest_MainActivity_longToCByteArray(
        JNIEnv *env,
        jobject /* this */,
        jlong value) {
...
extern "C"
jlong
Java_com_example_androidthings_pca6895servotest_MainActivity_byteArrayToClong(
        JNIEnv *env,
        jobject /* this */,
        jbyteArray buffer) {
