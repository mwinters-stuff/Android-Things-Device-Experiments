...
public class PCA9685 implements IODeviceInterface {
  ...
  public void setPinMode(int pin, @NonNull PinMode mode) throws IOException {
    throw new UnsupportedOperationException("setPinMode on PCA9685");
  }

  @NonNull
  @Override
  public PinState readPin(int pin) throws IOException {
    throw new UnsupportedOperationException("readPin on PCA9685");
  }

  @Override
  public void writePin(int pin, @NonNull PinState value) throws IOException {
    throw new UnsupportedOperationException("writePin on PCA9685");
  }
